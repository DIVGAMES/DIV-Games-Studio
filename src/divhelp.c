...
//      Mขdulo que contiene el cขdigo del hipertexto
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
int help_l,help_lines;          // Lกnea actual, y lineas totales
byte help_title[128];           // Tกtulo del trmino
...
int backto[64]; // Cola circular para almacenar los topicos consultados {n,lกnea}
...
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//      Crea el กndice para el hipertexto
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
*/
            ...
            if (n==9999) { // *** Extrae un ejemplo ***
              if ((di=p=(byte *)malloc(16384))!=NULL) {
                ...
                if ((v_prg=(struct tprg*)malloc(sizeof(struct tprg)))!=NULL) {
                  ...
                  nueva_ventana((memptrsize)programa0);
                }
    ...
    if (((scan_code==14&&!(shift_status&3)) || v.active_item==0) && a_back!=i_back) {
      ...
      if (backto[a_back]==help_item) {
        ...
        // *** OJO *** Esto no se para que !@#ฅ!! servกa ...
        // help_xref(backto[a_back],backto[a_back+1]);
      }
    }
...
void help0(void) { // En help_item se indica sobre que trmino se pide ayuda
  ...
  v.paint_handler=(memptrsize)help1;
  v.click_handler=(memptrsize)help2;
  v.close_handler=(memptrsize)help3;
...
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//      Cambia el tamaคo de la ventana de ayuda
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ

void resize_help(void) {
  int _mx=mouse_x,_my=mouse_y;  // Coordenadas del ratขn iniciales
  int my;                       // Coordenadas tabuladas del ratขn en cada momento
  int _al;                      // al original, en chr
  int old_al;                   // ฃltimo al
  byte *new_block;
  int an=v.an/big2,al=v.al/big2;
...
int determina_help(void) {
  ...
  for (m=0;m<max_windows;m++) {
    if (ventana[m].tipo==102 && ventana[m].click_handler==(memptrsize)help2) {
      n=m; break;
    }
  } return(n);
}
...
void help(int n){
  ...
  if ((m=determina_help())!=-1) {
    ...
    if (m && v.primer_plano==0) { // Si estaba en 2ง plano
    ...
    if((f=fopen("help/help.div","rb"))!=NULL) {
      ...
      if ((h_buffer=(byte*)malloc(helpidx[n*2+1]+2048))!=NULL) {
        if ((help_buffer=(byte*)malloc(helpidx[n*2+1]+2048))!=NULL) {
          ...
          nueva_ventana((memptrsize)help0);
        }
        //free(h_buffer);
      } fclose(f);
    }
    ...
    if((f=fopen("help/help.div","rb"))!=NULL) {
      ...
      if ((h_buffer=(byte*)malloc(helpidx[n*2+1]+2048))!=NULL) {
        if ((help_buffer=(byte*)malloc(helpidx[n*2+1]+2048))!=NULL) {
          ...
          tabula_help(p+1,help_buffer,helpidx[n*2+1]-(p+1-h_buffer));
          help_paint_active=1;
          dialogo((memptrsize)help_paint0);
          help_paint_active=0;
        }
        //free(h_buffer);
      } fclose(f);
...
int imagen=0;   // Cขdigo de la imagen
...
//      c=*si++;
    ...
    // Mientras vengan chars o saltos de lกnea
    ...
    if (c!=0 || !ultimo_cr) {
      ...
      if (c) { // Si viene un car cter
        ...
        if (!ejemplo && chars==help_an+1) {
          ...
          chars2=chars; help_an2=help_an; // Arreglar la lกnea que se truncข
          ...
          di2=di; // Donde termina la lกnea anterior
...
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//      Impresiขn parcial de una imagen
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
        ...
        if (c=='{') {
          switch(*si) {
            ...
            case '/': // Lกnea
              ...
              strcpy((char *)di,"ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ");
              di+=strlen((char *)di)+1;
              ultimo_cr=1; chars=0;
              continue;
...
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//  Opciขn de impresiขn de una p gina de ayuda
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
void Print_Help(void) {
  ...
  if (v_aceptar) {
    ...
    if (f_ar) {
      ...
      g=fopen(h_ar,"wb");
      if (g==NULL) { v_texto=(char *)texto[47]; dialogo((memptrsize)err0); return; }
    } else g=stdprn;
    ...
    if((f=fopen("help/help.div","rb"))!=NULL) {
      ...
      if ((h_buffer=(byte*)malloc(helpidx[help_item*2+1]+2048))!=NULL) {
        if ((print_buffer=(byte*)malloc(helpidx[help_item*2+1]+2048))!=NULL) {
          ...
          // Imprime el tกtulo de la p gina de ayuda

          fwrite("\xd\xa",1,2,g);
          for (n=0;n<(ancho_ayuda-strlen((char *)help_title)-4)/2;n++) fwrite(" ",1,1,g);
          fwrite("[ ",1,2,g);
          fwrite(help_title,1,strlen((char *)help_title),g);
          fwrite(" ]\xd\xa\xd\xaฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ",1,76,g);
