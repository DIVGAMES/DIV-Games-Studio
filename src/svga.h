 ...
 *				library provides a simplified interface to
 *SuperVGA cards that have a VESA VBE (or with the Universal VESA VBE
 *installed). This library requires at least a VBE 1.2 interface to function
 *correctly.
 *
 *				For performance in protected modes, the SuperVGA
 *Kit internally caches the video memory selector in the GS register, and uses
 *the VBE 2.0 32 bit protected mode routines.
 *
