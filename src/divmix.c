...
struct t_listbox lvol_fx = {
    MIX_BAR1, 11, DummyArrayForFakingPurposesUsedInMixer, 1, 5, 1};
struct t_listbox lvol_cd = {
    MIX_BAR2, 11, DummyArrayForFakingPurposesUsedInMixer, 1, 5, 1};
struct t_listbox lvol_ma = {
    MIX_BAR3, 11, DummyArrayForFakingPurposesUsedInMixer, 1, 5, 1};
