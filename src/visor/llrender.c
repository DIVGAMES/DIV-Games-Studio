...
void llrender_clipping_3d_near(llrender *llrender_struct,lptface face_in)
{
  ...
  //  Calculamos cuantos puntos están situados detras del plano de clipping
  ...
  i=(i>>8)&3;
  if (i==3) return; // El polígono está fuera de pantalla
  if (i==0) {
    llrender_clipping_3d_left(llrender_struct,face_in); // El polígono está dentro de pantalla
    return;
  }
...
void llrender_clipping_3d_left(llrender *llrender_struct,lptface face_in)
{
  ...
  if (i==3) return; // El polígono está fuera de pantalla
  if (i==0) {
    llrender_clipping_3d_right(llrender_struct,face_in); // El polígono está dentro de pantalla
    return;
  }
...
void llrender_clipping_3d_right(llrender *llrender_struct,lptface face_in)
{
  ...
  if (i==3) return; // El polígono está fuera de pantalla
  if (i==0) {
    llrender_clipping_3d_up(llrender_struct,face_in); // El polígono está dentro de pantalla
    return;
  }
...
void llrender_clipping_3d_up(llrender *llrender_struct,lptface face_in)
{
  ...
  if (i==3) return; // El polígono está fuera de pantalla
  if (i==0) {
    llrender_clipping_3d_down(llrender_struct,face_in); // El polígono está dentro de pantalla
    return;
  }
...
void llrender_clipping_3d_down(llrender *llrender_struct,lptface face_in)
{
  ...
  if (i==3) return; // El polígono está fuera de pantalla
  if (i==0) {
    llrender_pintar_triangulo(llrender_struct,face_in); // El polígono está dentro de pantalla
    return;
  }
