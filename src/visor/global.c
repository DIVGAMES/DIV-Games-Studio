...
void IniMath()
{
	Identity._00 = (float)1.0;
	Identity._01 = (float)0.0;
	Identity._02 = (float)0.0;
	Identity._03 = (float)0.0;
	Identity._10 = (float)0.0;
	Identity._11 = (float)1.0;
	Identity._12 = (float)0.0;
	Identity._13 = (float)0.0;
	Identity._20 = (float)0.0;
	Identity._21 = (float)0.0;
	Identity._22 = (float)1.0;
	Identity._23 = (float)0.0;
	Identity._30 = (float)0.0;
	Identity._31 = (float)0.0;
	Identity._32 = (float)0.0;
	Identity._33 = (float)1.0;
}
...
void GetAngs(lptmatrix mat, float *ax, float *ay, float *az, float *x, float *y,
	     float *z)
{
	*x = mat->_30;
	*y = mat->_31;
