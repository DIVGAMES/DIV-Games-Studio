...
{
	//	if (OSDEP_surface->flags & SDL_FULLSCREEN) return 1; // return
	//true if surface is fullscreen
	//    return 0;//OSDEP_window->fullscreen; // Return false if surface is
	//    windowed
...
OSDEP_Surface *OSDEP_SetVideoMode(int width, int height, int bpp, char fs)
{
	...
	OSDEP_texture =
	    SDL_CreateTextureFromSurface(OSDEP_renderer, OSDEP_buffer32);
...
void OSDEP_Flip(OSDEP_Surface *s)
{
	...
	SDL_UpdateTexture(OSDEP_texture, NULL, OSDEP_buffer32->pixels,
