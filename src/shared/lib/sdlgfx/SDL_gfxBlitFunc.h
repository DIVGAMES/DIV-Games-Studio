...
SDL_GFXBLITFUNC_SCOPE int SDL_gfxBlitRGBA(SDL_Surface *src, SDL_Rect *srcrect,
...
/*!
	\brief Unwrap RGBA values from a pixel using mask, shift and loss for
   surface.
	*/
...
/*!
	\brief Wrap a pixel from RGBA values using mask, shift and loss for
   surface.
	*/
