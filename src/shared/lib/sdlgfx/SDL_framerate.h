...
/*!
	\brief Highest possible rate supported by framerate controller in Hz
   (1/s).
	*/
#define FPS_UPPER_LIMIT 200

/*!
	\brief Lowest possible rate supported by framerate controller in Hz
   (1/s).
	*/
...
/*!
	\brief Structure holding the state and timing information of the
