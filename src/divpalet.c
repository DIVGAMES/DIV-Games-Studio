...
//�����������������������������������������������������������������������������
void ReloadFont(int ventana, tventana *vntn);
...
void RefPalAndDlg(int no_tocar_mapas,int guardar_original)
{
  ...
  for (n=1;n<max_windows;n++)
  {
        if (ventana[n].tipo==104)
                ReloadFont(n, (tventana *)&ventana[n].tipo);
  }
...
char Valores[72*1];
t_listbox lRed={132   ,63,Valores,1,9,1};
t_listbox lGre={132+11,63,Valores,1,9,1};
t_listbox lBlu={132+22,63,Valores,1,9,1};
