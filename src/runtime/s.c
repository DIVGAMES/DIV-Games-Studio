...
void scroll_parallax(void) {
	...
	si1  = iscroll[snum].scr_1;
	si2  = iscroll[snum].scr_2;
	di   = copia + iscroll[snum].x + iscroll[snum].y * vga_an;
...
void set_scroll(int plano, int x, int y) {
	...
	if(plano == 0) {
		...
		di = iscroll[snum].scr_1 = iscroll[snum]._scr_1;
	}
	else {
		...
		di = iscroll[snum].scr_2 = iscroll[snum]._scr_2;
	}
...
void process_scan(int n) { // Reprocesa un scan por completo
	...
	si              = iscroll[snum].scr_1 + n * iscroll[snum].an;
	an              = iscroll[snum].an;
	fast[in].inc[0] = 0;
	do {
		if(*si++) {
...
void process_scan_right(void) {
	...
	si    = iscroll[snum].scr_1 + iscroll[snum].an - 1; // Final de la primera línea
	n     = iscroll[snum].al;
	do {
...
void move_scroll(int plano, int x, int y) {
	...
	if(ix > 0) {
		do {
			if(plano == 0) {
				iscroll[snum].scr_1 = scroll_right(iscroll[snum]._scr_1,
				                                  iscroll[snum].scr_1,
				                                 &iscroll[snum].block1,
				                                  iscroll[snum].map1,
				...
				iscroll[snum].scr_2 = scroll_right(iscroll[snum]._scr_2,
				                                  iscroll[snum].scr_2,
				                                 &iscroll[snum].block2,
				                                  iscroll[snum].map2,
	...
	if(ix < 0) {
		do {
			if(plano == 0) {
				iscroll[snum].scr_1 = scroll_left(iscroll[snum]._scr_1,
				                                 iscroll[snum].scr_1,
				                                &iscroll[snum].block1,
				                                 iscroll[snum].map1,
				                                 iscroll[snum].map1_an,
				...
				iscroll[snum].scr_2 = scroll_left(iscroll[snum]._scr_2,
				                                 iscroll[snum].scr_2,
				                                &iscroll[snum].block2,
				                                 iscroll[snum].map2,
				                                 iscroll[snum].map2_an,
	...
	if(iy > 0) {
		do {
			if(plano == 0) {
				iscroll[snum].scr_1 = scroll_down(iscroll[snum]._scr_1,
				                                 iscroll[snum].scr_1,
				                                &iscroll[snum].block1,
				                                 iscroll[snum].map1,
				                                 iscroll[snum].map1_an,
				...
				iscroll[snum].scr_2 = scroll_down(iscroll[snum]._scr_2,
				                                 iscroll[snum].scr_2,
				                                &iscroll[snum].block2,
				                                 iscroll[snum].map2,
				                                 iscroll[snum].map2_an,
	...
	if(iy < 0) {
		do {
			if(plano == 0) {
				iscroll[snum].scr_1 = scroll_up(iscroll[snum]._scr_1,
				                               iscroll[snum].scr_1,
				                              &iscroll[snum].block1,
				                               iscroll[snum].map1,
				                               iscroll[snum].map1_an,
				...
				iscroll[snum].scr_2 = scroll_up(iscroll[snum]._scr_2,
				                               iscroll[snum].scr_2,
				                              &iscroll[snum].block2,
				                               iscroll[snum].map2,
				                               iscroll[snum].map2_an,
