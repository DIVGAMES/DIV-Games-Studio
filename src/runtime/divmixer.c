...
void set_mixer(void)
{
	...
	InitMixer(judascfg_device, judascfg_port, setup->master,
		  setup->sound_fx, setup->cd_audio);
#endif
}
...
void set_init_mixer(void)
{
	...
	if (judascfg_device == DEV_SB || judascfg_device == DEV_SBPRO ||
