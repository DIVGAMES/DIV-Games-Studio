...
void UpdateFloor(VPEShort, VPEShort, VPEShort, struct VLine *, struct PicInfo *,
		 struct Region *);
void UpdateAboveHole(VPEShort, VPEShort, VPEShort, struct VLine *,
		     struct PicInfo *, struct Region *);
void UpdateBelowHole(VPEShort, VPEShort, VPEShort, struct VLine *,
		     struct PicInfo *, struct Region *);
void UpdateBack(VPEShort, VPEShort, VPEShort, struct VLine *, struct PicInfo *,
		struct Region *);
