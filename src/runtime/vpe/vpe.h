...
struct Region *FindRegion(VPEFixed, VPEFixed, VPEFixed,
			  int);			     // Find region from coords
...
VPEFixed FixDist(VPEFixed, VPEFixed, VPEFixed,
		 VPEFixed); // Fast approx for distance
